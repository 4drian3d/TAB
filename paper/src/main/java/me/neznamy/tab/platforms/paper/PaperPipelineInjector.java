...
import me.neznamy.tab.platforms.paper.nms.storage.packet.PacketPlayOutScoreboardObjectiveStorage;
import me.neznamy.tab.platforms.paper.nms.storage.packet.PacketPlayOutScoreboardTeamStorage;
...
public class PaperPipelineInjector extends PipelineInjector {
     ...
     */
    @AllArgsConstructor
    public class PaperChannelDuplexHandler extends ChannelDuplexHandler {
